...
To determine the relationships between numerical We calculated Pearson's r and visually represented correlation using a correlation plot.
...
```{r model-logs}
full_log <- lm(log(totmass) ~ totmass ~ species + feedlevel + sla + chlorophyll + amass + num_lvs + num_phylls, data = plant_subset)
