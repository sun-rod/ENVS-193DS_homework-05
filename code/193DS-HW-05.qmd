...
Model 4 takes into account number of leaves, chlorophyll content, feed level, and species. It says that these variables are good predictors of the total mass of the sarracenia plants.

```{r predictions}
ggpredict(model4_log)
```
